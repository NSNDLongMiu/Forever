...
const images = [
  'https://vietnam9.net/wp-content/uploads/2020/08/AS.png',
  'https://cdn.printgo.vn/uploads/media/772948/tong-hop-nhung-mau-logo-dep-bong-da-the-gioi-va-viet-nam-2_1584083905.jpg',
...
const data = Array(10).fill('').map((e, i) => ({ id: i + 1, image: images[i] || images[1], name: `item ${i}`, price: '100.000', star: 4 }))
    ...
    <View style={{ borderWidth: 1, borderColor: 'green', flex: 1 }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 5, backgroundColor: 'white', paddingVertical: 10, borderBottomWidth: 0.5 }}>
        <TouchableOpacity
          ...
          <MaterialIcons name="sort" size={30} color={'black'} style={{ marginRight: 5 }} />
          <Text>SORT BY</Text>
        </TouchableOpacity>
